...
function Sidebar() {
    ...
    const servers = 'https://cdn.discordapp.com/icons/501709061876744202/a_e82d70a01ea060de05da25394620938d.gif '
        .repeat(20)
        .split(' ');
    return (
        <div className="flex flex-row overflow-hidden">
            <div className='max-h-[93vh] overflow-y-auto space-y-3 pr-2 bg-card'>
                {servers.map((server) => {
                    return (
                        <div className="">
                            <img
                                ...
                                src={server}
                                alt="Server Icon"
                                className=" h-14 w-14 rounded-full  space-y-4"
                            />
                        </div>
                    );
                })}
            </div>
            <div className=" w-64 bg-card  text-white p-4">
